...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.9304892399533914,
  lambda_l1=0.4324866751425751,
  lambda_l2=192.09310620857713,
  learning_rate=0.16190593104536352,
  max_bin=32,
  min_child_samples=109,
  n_estimators=4459,
  num_leaves=45,
  subsample=0.4143418096169481,
