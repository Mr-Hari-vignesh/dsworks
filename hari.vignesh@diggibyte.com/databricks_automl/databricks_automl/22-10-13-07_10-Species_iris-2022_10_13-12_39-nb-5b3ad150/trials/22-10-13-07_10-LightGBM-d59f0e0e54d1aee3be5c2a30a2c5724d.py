...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.15297853203704315,
  lambda_l1=0.13807116183872742,
  lambda_l2=0.0011403361503482922,
  learning_rate=0.0042246994588981904,
  max_bin=16,
  min_child_samples=102,
  n_estimators=10220,
  num_leaves=51,
  subsample=0.7367542539385497,
