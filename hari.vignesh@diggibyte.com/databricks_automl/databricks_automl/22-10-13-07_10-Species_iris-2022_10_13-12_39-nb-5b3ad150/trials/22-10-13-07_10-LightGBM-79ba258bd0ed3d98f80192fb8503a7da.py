...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.9077610347722245,
  lambda_l1=4.412693510722442,
  lambda_l2=0.8952922907708494,
  learning_rate=0.4032442763853139,
  max_bin=8,
  min_child_samples=8,
  n_estimators=21310,
  num_leaves=9,
  subsample=0.6594115231416169,
