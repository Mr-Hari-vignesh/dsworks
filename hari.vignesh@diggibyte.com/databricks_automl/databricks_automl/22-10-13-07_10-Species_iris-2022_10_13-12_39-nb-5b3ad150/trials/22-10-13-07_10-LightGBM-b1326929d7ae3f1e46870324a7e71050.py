...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.7674415060716849,
  lambda_l1=0.0011909006303155972,
  lambda_l2=10.1295230162961,
  learning_rate=0.1783408140255103,
  max_bin=16,
  min_child_samples=3,
  n_estimators=7649,
  num_leaves=9,
  subsample=0.3754448910829269,
