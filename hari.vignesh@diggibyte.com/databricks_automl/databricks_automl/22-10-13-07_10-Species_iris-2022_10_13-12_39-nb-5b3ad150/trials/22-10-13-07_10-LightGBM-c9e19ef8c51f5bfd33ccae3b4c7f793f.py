...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.40209583590951453,
  lambda_l1=1.0327293900925643,
  lambda_l2=0.09891046206723933,
  learning_rate=0.0171343475706058,
  max_bin=128,
  min_child_samples=76,
  n_estimators=19495,
  num_leaves=10,
  subsample=0.31727238150196596,
