...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.5968856380677637,
  lambda_l1=0.08787313673378382,
  lambda_l2=5.290312379852297,
  learning_rate=0.016119449402915344,
  max_bin=8,
  min_child_samples=23,
  n_estimators=20,
  num_leaves=7,
  subsample=0.21476112425942798,
