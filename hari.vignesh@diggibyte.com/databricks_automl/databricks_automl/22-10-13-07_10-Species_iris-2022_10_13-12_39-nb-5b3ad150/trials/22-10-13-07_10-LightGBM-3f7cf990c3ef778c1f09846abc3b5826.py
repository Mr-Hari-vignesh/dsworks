...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.5321345789399674,
  lambda_l1=0.09693414706192553,
  lambda_l2=24.25503153592838,
  learning_rate=0.0032829449531796297,
  max_bin=128,
  min_child_samples=19,
  n_estimators=9,
  num_leaves=446,
  subsample=0.10676675263064657,
