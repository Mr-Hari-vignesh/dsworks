...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.584961120283549,
  lambda_l1=0.09998325849547475,
  lambda_l2=0.0682727921299472,
  learning_rate=0.0013229336484848711,
  max_bin=8,
  min_child_samples=22,
  n_estimators=4,
  num_leaves=300,
  subsample=0.9821249704262524,
