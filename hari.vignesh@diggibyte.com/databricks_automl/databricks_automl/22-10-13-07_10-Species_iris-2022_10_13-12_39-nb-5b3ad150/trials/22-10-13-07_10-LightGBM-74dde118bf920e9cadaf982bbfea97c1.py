...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.18025539857655581,
  lambda_l1=0.005096596766681335,
  lambda_l2=0.08684090646448597,
  learning_rate=0.001672675799079242,
  max_bin=4,
  min_child_samples=5,
  n_estimators=52,
  num_leaves=13208,
  subsample=0.10412452467156184,
