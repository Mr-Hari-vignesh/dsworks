...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.8244920583987599,
  lambda_l1=0.004010949741070379,
  lambda_l2=56.19961011634495,
  learning_rate=0.0027606620064987795,
  max_bin=4,
  min_child_samples=15,
  n_estimators=158,
  num_leaves=2366,
  subsample=0.35891522675863685,
