...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.8970426352909714,
  lambda_l1=0.043086744344007805,
  lambda_l2=0.2114387834079668,
  learning_rate=0.3237299284447961,
  max_bin=32,
  min_child_samples=11,
  n_estimators=50,
  num_leaves=112,
  subsample=0.2358453789839317,
