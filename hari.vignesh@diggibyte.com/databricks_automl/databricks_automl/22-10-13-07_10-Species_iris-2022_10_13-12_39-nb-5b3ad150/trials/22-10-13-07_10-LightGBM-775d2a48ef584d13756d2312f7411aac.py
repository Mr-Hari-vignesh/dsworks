...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.76354177695634,
  lambda_l1=0.012619784820067445,
  lambda_l2=4.048919706881021,
  learning_rate=0.09994758598933001,
  max_bin=512,
  min_child_samples=79,
  n_estimators=75,
  num_leaves=640,
  subsample=0.18084907890486843,
