...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.6978727533607165,
  lambda_l1=43.99005845520483,
  lambda_l2=0.0060395941127681565,
  learning_rate=0.1981188966946636,
  max_bin=8,
  min_child_samples=61,
  n_estimators=361,
  num_leaves=12076,
  subsample=0.5042721298815218,
