...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.290743790234313,
  lambda_l1=2.3621424355794507,
  lambda_l2=0.006419848204370654,
  learning_rate=0.1118194616985568,
  max_bin=16,
  min_child_samples=10,
  n_estimators=106,
  num_leaves=121,
  subsample=0.9576157729316326,
