...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.7900792718691464,
  lambda_l1=276.85559740993705,
  lambda_l2=0.0012441010691228496,
  learning_rate=0.031226570455907612,
  max_bin=32,
  min_child_samples=17,
  n_estimators=728,
  num_leaves=8081,
  subsample=0.4359427662983202,
