...
lgbmr_regressor = LGBMRegressor(
  colsample_bytree=0.3487977613284207,
  lambda_l1=0.00822945664778234,
  lambda_l2=0.003430595364719882,
  learning_rate=0.4358849240323778,
  max_bin=32,
  min_child_samples=34,
  n_estimators=1086,
  num_leaves=29,
  subsample=0.10678510174045286,
