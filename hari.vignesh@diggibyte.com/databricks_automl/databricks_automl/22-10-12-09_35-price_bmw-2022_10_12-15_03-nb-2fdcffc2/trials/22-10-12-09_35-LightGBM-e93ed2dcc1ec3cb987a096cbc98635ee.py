...
lgbmr_regressor = LGBMRegressor(
  colsample_bytree=0.7837039246893723,
  lambda_l1=113.1307197358167,
  lambda_l2=0.001428509977518259,
  learning_rate=0.023588075896594514,
  max_bin=4,
  min_child_samples=53,
  n_estimators=222,
  num_leaves=28,
  subsample=0.8788767528611269,
