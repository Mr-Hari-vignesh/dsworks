...
// MAGIC 
// MAGIC 
// MAGIC url = f"https://randomuser.me/api/"
// MAGIC 
// MAGIC  
// MAGIC 
...
// MAGIC   url = url,
// MAGIC )
// MAGIC json_data = json.loads(response.text)
// MAGIC 
// MAGIC  
// MAGIC 
// MAGIC api_data = json.dumps(json_data)
// MAGIC print(api_data)
